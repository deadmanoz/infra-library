    ...
    services.bitcoind."mainnet" = {
      ...
      extraConfig = ''
        ...
        ${optionalString (config.services.peer-observer.extractors.rpc.enable) ''
          ...
          rpcwhitelist=rpc-extractor:getpeerinfo,getmempoolinfo,uptime,getnettotals,getaddrmaninfo,getmemoryinfo,getchaintxstats,getnetworkinfo,getblockchaininfo,getorphantxs
